...
def backward(old_orm, new_orm):
    news = new_orm['news']
    return [
        # Apply default value datetime.datetime(2023, 7, 4, 2, 53, 56, 541012) to the field news.date_collect,
        news.update({news.date_collect: datetime.datetime(2023, 7, 4, 2, 53, 56, 541012)}).where(news.date_collect.is_null(True)),
    ]
