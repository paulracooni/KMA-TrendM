...
from src.modules.news_gpt.tasks import TaskChecker
from src.modules.news_gpt.determinator import GptDeterminator
from src.modules.news_gpt.classifier import GptClsSector
